        ...
        if self.mode=='train':
            ...
            if augmentation==1:
                ...
                transform_ = transforms.Compose([ 
                                    # transforms.RandomErasing(scale=(0.01,0.02),ratio=(0.01,0.05), p=1),
...
for batch_size in batch_size_arr:
    for lr in lr_arr:
        ...
        for epoch in range(epochs):
            ...
            # # print(add_arr)
            # submission.to_csv(pathLabel+f"submissions/K_train_with_affine_aug_epochs{epoch}_{batch_size}_lr_{lr}_val_f1_{val_f1}.csv", index = False)
