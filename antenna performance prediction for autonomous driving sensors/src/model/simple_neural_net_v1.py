...
<<<<<<<< HEAD:antenna performance prediction for autonomous driving sensors/src/model/simple_neural_net_v3.py
...
>>>>>>>> 4ee87e8288028d65a1dae4798f6e25dc9616abe1:antenna performance prediction for autonomous driving sensors/src/model/simple_neural_net_v1.py
...
========
    optimizer = optim.Adam(model.parameters(),lr=0.0008721283678589154)
